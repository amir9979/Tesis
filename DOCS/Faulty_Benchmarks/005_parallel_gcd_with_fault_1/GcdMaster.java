 ...
 * 
 * Fault:       "Incorrect sender specified for a message"
 *               Line with fault: 136 - GcdMaster Process
 *              
 *               
 * Year:         2015
...
/* TEST 1 - always reveal the first fault - "Incorrect sender specified for a message"
 * java GcdSlave 1
 * java GcdSlave 2
 * java GcdSlave 3
 ...
 * Result = 1
 *
 * But, because of the fault, the test 1 does not show output
 */
...
public class GcdMaster {
    public static void main(String[] args) throws IOException {
        ...
        if (receivedValueOfProcess1 == 1 || receivedValueOfProcess2 == 1) {
            ...
            sendValueToSlave(socket, values, remoteIPSlave2, remotePortSlave2); // Fault - send message to slave 2 instead of slave 3
